...
export default createStore({
  ...
  actions: {
    ...
    EditFeed({ commit }, payload) {
      ...
      axios.put(`http://localhost:5000/api/feed/${payload.id}`, formData, {
        headers: {
    ...
    deleteFeed({ commit }, payload) {
      axios.delete(`http://localhost:5000/api/feed/${payload.id}`, payload, {
        headers: {
          'content-type': 'application/json',
        }
      }).then(res => {
    ...
    dislikedFeed({ commit }, payload) {
      axios.put(`http://localhost:5000/api/feed/dislike/${payload.id}`, payload, {
        headers: {
          'content-type': 'application/json',
        }
      }).then((res) => {
    ...
    EditComment({ commit }, payload) {
      axios.put(`http://localhost:5000/api/feed/comment/${payload.id}`, payload, {
        headers: {
          'content-type': 'application/json',
        }
      }).then(res => {
    ...
    deleteComment({ commit }, payload) {
      axios.put(`http://localhost:5000/api/feed/comment/d/${payload.id}`, payload, {
        headers: {
          'content-type': 'application/json',
        }
      }).then(res => {
